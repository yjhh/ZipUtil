...
import com.zipHandle.dao.performance_schema.enums.EventsStagesHistoryNestingEventType;
import com.zipHandle.dao.performance_schema.tables.records.EventsStagesHistoryRecord;
...
public class EventsStagesHistory extends TableImpl<EventsStagesHistoryRecord> {
    ...
    private static final long serialVersionUID = -626668087;
     ...
     */
    public final TableField<EventsStagesHistoryRecord, EventsStagesHistoryNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.zipHandle.dao.performance_schema.enums.EventsStagesHistoryNestingEventType.class), this, "");
