...
import com.zipHandle.dao.mysql.enums.TimeZoneUseLeapSeconds;
...
public class TimeZone extends TableImpl<TimeZoneRecord> {
    ...
    private static final long serialVersionUID = -401715796;
     ...
     */
    public final TableField<TimeZoneRecord, TimeZoneUseLeapSeconds> USE_LEAP_SECONDS = createField("Use_leap_seconds", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.zipHandle.dao.mysql.enums.TimeZoneUseLeapSeconds.class), this, "");
