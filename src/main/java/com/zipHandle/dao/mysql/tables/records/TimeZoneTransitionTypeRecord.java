...
public class TimeZoneTransitionTypeRecord extends UpdatableRecordImpl<TimeZoneTransitionTypeRecord> implements Record5<UInteger, UInteger, Integer, Boolean, String> {

    private static final long serialVersionUID = 51064307;
     ...
     */
    @Override
    public Row5<UInteger, UInteger, Integer, Boolean, String> fieldsRow() {
     ...
     */
    @Override
    public Row5<UInteger, UInteger, Integer, Boolean, String> valuesRow() {
     ...
     */
    @Override
    public TimeZoneTransitionTypeRecord value4(Boolean value) {
        setIsDst(value);
        return this;
    }
     ...
     */
    @Override
    public TimeZoneTransitionTypeRecord values(UInteger value1, UInteger value2, Integer value3, Boolean value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TimeZoneTransitionTypeRecord(UInteger timeZoneId, UInteger transitionTypeId, Integer offset, Boolean isDst, String abbreviation) {
        super(TimeZoneTransitionType.TIME_ZONE_TRANSITION_TYPE);
