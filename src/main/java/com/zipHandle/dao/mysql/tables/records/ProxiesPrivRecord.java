...
public class ProxiesPrivRecord extends UpdatableRecordImpl<ProxiesPrivRecord> implements Record7<String, String, String, String, Boolean, String, Timestamp> {

    private static final long serialVersionUID = 1127223821;
     ...
     */
    public void setWithGrant(Boolean value) {
        set(4, value);
    }
     ...
     */
    @Override
    public Row7<String, String, String, String, Boolean, String, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row7<String, String, String, String, Boolean, String, Timestamp> valuesRow() {
     ...
     */
    @Override
    public ProxiesPrivRecord value5(Boolean value) {
        setWithGrant(value);
        return this;
    }
     ...
     */
    @Override
    public ProxiesPrivRecord values(String value1, String value2, String value3, String value4, Boolean value5, String value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProxiesPrivRecord(String host, String user, String proxiedHost, String proxiedUser, Boolean withGrant, String grantor, Timestamp timestamp) {
        super(ProxiesPriv.PROXIES_PRIV);
