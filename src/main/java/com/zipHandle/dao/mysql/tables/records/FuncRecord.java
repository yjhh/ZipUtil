...
public class FuncRecord extends UpdatableRecordImpl<FuncRecord> implements Record4<String, Boolean, String, FuncType> {

    private static final long serialVersionUID = -994596115;
     ...
     */
    @Override
    public Row4<String, Boolean, String, FuncType> fieldsRow() {
     ...
     */
    @Override
    public Row4<String, Boolean, String, FuncType> valuesRow() {
     ...
     */
    @Override
    public FuncRecord value2(Boolean value) {
        setRet(value);
        return this;
    }
     ...
     */
    @Override
    public FuncRecord values(String value1, Boolean value2, String value3, FuncType value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FuncRecord(String name, Boolean ret, String dl, FuncType type) {
        super(Func.FUNC);
