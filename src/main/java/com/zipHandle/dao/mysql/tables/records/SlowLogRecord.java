...
public class SlowLogRecord extends TableRecordImpl<SlowLogRecord> implements Record12<Timestamp, String, Time, Time, Integer, Integer, String, Integer, Integer, UInteger, String, ULong> {

    private static final long serialVersionUID = -1216423803;
     ...
     */
    @Override
    public Row12<Timestamp, String, Time, Time, Integer, Integer, String, Integer, Integer, UInteger, String, ULong> fieldsRow() {
     ...
     */
    @Override
    public Row12<Timestamp, String, Time, Time, Integer, Integer, String, Integer, Integer, UInteger, String, ULong> valuesRow() {
     ...
     */
    @Override
    public SlowLogRecord values(Timestamp value1, String value2, Time value3, Time value4, Integer value5, Integer value6, String value7, Integer value8, Integer value9, UInteger value10, String value11, ULong value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SlowLogRecord(Timestamp startTime, String userHost, Time queryTime, Time lockTime, Integer rowsSent, Integer rowsExamined, String db, Integer lastInsertId, Integer insertId, UInteger serverId, String sqlText, ULong threadId) {
        super(SlowLog.SLOW_LOG);
