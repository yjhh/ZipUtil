...
public class TimeZoneTransitionType extends TableImpl<TimeZoneTransitionTypeRecord> {
    ...
    private static final long serialVersionUID = -1719893731;
     ...
     */
    public final TableField<TimeZoneTransitionTypeRecord, Boolean> IS_DST = createField("Is_DST", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
