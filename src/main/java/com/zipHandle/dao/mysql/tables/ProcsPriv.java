...
import com.zipHandle.dao.mysql.enums.ProcsPrivRoutineType;
...
public class ProcsPriv extends TableImpl<ProcsPrivRecord> {
    ...
    private static final long serialVersionUID = 598926534;
     ...
     */
    public final TableField<ProcsPrivRecord, ProcsPrivRoutineType> ROUTINE_TYPE = createField("Routine_type", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.zipHandle.dao.mysql.enums.ProcsPrivRoutineType.class), this, "");
