...
public class SlaveMasterInfo extends TableImpl<SlaveMasterInfoRecord> {
    ...
    private static final long serialVersionUID = -857154424;
     ...
     */
    public final TableField<SlaveMasterInfoRecord, String> HOST = createField("Host", org.jooq.impl.SQLDataType.CHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "The host name of the master.");
     ...
     */
    public final TableField<SlaveMasterInfoRecord, Boolean> ENABLED_SSL = createField("Enabled_ssl", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "Indicates whether the server supports SSL connections.");
     ...
     */
    public final TableField<SlaveMasterInfoRecord, Boolean> SSL_VERIFY_SERVER_CERT = createField("Ssl_verify_server_cert", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "Whether to verify the server certificate.");
     ...
     */
    public final TableField<SlaveMasterInfoRecord, Boolean> ENABLED_AUTO_POSITION = createField("Enabled_auto_position", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "Indicates whether GTIDs will be used to retrieve events from the master.");
