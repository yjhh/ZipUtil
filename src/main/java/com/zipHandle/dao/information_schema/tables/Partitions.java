...
import com.zipHandle.dao.information_schema.tables.records.PartitionsRecord;
...
public class Partitions extends TableImpl<PartitionsRecord> {
    ...
    private static final long serialVersionUID = -17702599;
     ...
     */
    public final TableField<PartitionsRecord, String> TABLE_CATALOG = createField("TABLE_CATALOG", org.jooq.impl.SQLDataType.VARCHAR.length(512).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
