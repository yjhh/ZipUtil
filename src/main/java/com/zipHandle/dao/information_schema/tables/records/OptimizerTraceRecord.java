...
public class OptimizerTraceRecord extends TableRecordImpl<OptimizerTraceRecord> implements Record4<String, String, Integer, Boolean> {

    private static final long serialVersionUID = 1365136719;
     ...
     */
    @Override
    public OptimizerTraceRecord value4(Boolean value) {
     ...
     */
    @Override
    public OptimizerTraceRecord values(String value1, String value2, Integer value3, Boolean value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OptimizerTraceRecord(String query, String trace, Integer missingBytesBeyondMaxMemSize, Boolean insufficientPrivileges) {
        super(OptimizerTrace.OPTIMIZER_TRACE);
