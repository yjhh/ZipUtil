...
import com.zipHandle.dao.information_schema.tables.records.InnodbSysFieldsRecord;
...
public class InnodbSysFields extends TableImpl<InnodbSysFieldsRecord> {
    ...
    private static final long serialVersionUID = -1094285291;
     ...
     */
    public final TableField<InnodbSysFieldsRecord, String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR.length(193).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
