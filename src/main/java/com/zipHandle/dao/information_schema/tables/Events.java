...
import com.zipHandle.dao.information_schema.tables.records.EventsRecord;
...
public class Events extends TableImpl<EventsRecord> {
    ...
    private static final long serialVersionUID = 1048049177;
     ...
     */
    public final TableField<EventsRecord, String> EVENT_CATALOG = createField("EVENT_CATALOG", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
