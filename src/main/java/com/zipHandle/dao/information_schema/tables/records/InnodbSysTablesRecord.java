...
public class InnodbSysTablesRecord extends TableRecordImpl<InnodbSysTablesRecord> implements Record8<ULong, String, Integer, Integer, Integer, String, String, UInteger> {

    private static final long serialVersionUID = -1100861784;
     ...
     */
    @Override
    public Row8<ULong, String, Integer, Integer, Integer, String, String, UInteger> fieldsRow() {
     ...
     */
    @Override
    public Row8<ULong, String, Integer, Integer, Integer, String, String, UInteger> valuesRow() {
     ...
     */
    @Override
    public InnodbSysTablesRecord values(ULong value1, String value2, Integer value3, Integer value4, Integer value5, String value6, String value7, UInteger value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public InnodbSysTablesRecord(ULong tableId, String name, Integer flag, Integer nCols, Integer space, String fileFormat, String rowFormat, UInteger zipPageSize) {
        super(InnodbSysTables.INNODB_SYS_TABLES);
