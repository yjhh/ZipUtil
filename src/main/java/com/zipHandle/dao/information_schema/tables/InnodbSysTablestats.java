...
import com.zipHandle.dao.information_schema.tables.records.InnodbSysTablestatsRecord;
...
public class InnodbSysTablestats extends TableImpl<InnodbSysTablestatsRecord> {
    ...
    private static final long serialVersionUID = -1704188242;
     ...
     */
    public final TableField<InnodbSysTablestatsRecord, String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR.length(193).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INNODB_SYS_TABLESTATS.STATS_INITIALIZED</code>.
     */
    public final TableField<InnodbSysTablestatsRecord, String> STATS_INITIALIZED = createField("STATS_INITIALIZED", org.jooq.impl.SQLDataType.VARCHAR.length(193).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
