...
import com.zipHandle.dao.information_schema.tables.records.InnodbFtDefaultStopwordRecord;
...
public class InnodbFtDefaultStopword extends TableImpl<InnodbFtDefaultStopwordRecord> {
    ...
    private static final long serialVersionUID = 1406183483;
     ...
     */
    public final TableField<InnodbFtDefaultStopwordRecord, String> VALUE = createField("value", org.jooq.impl.SQLDataType.VARCHAR.length(18).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
