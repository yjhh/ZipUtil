...
public class InnodbSysIndexesRecord extends TableRecordImpl<InnodbSysIndexesRecord> implements Record7<ULong, String, ULong, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = -352606435;
     ...
     */
    @Override
    public Row7<ULong, String, ULong, Integer, Integer, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row7<ULong, String, ULong, Integer, Integer, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public InnodbSysIndexesRecord values(ULong value1, String value2, ULong value3, Integer value4, Integer value5, Integer value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public InnodbSysIndexesRecord(ULong indexId, String name, ULong tableId, Integer type, Integer nFields, Integer pageNo, Integer space) {
        super(InnodbSysIndexes.INNODB_SYS_INDEXES);
